...
import com.template.flows.internal.GetStockStateAndRefFlow
import com.template.flows.internal.ReserveProductsFlowInitiator
        ...
        override fun call() {
            val signedTransaction = subFlow(object : SignTransactionFlow(counterpartySession) {
                ...
                override fun checkTransaction(stx: SignedTransaction) {
                    ...
                    requireThat {
                        "Command should be of type PurchaseOrderContract.Commands.Create. Got: $currentCommand" using
            ...
            subFlow(ReserveProductsFlowInitiator(purchaseOrderState.linearId, purchaseOrderState.products))
