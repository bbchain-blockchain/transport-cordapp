    ...
    */
    ...
    class Initiator(
        ...
        override fun call() {
            ...
            val newDeliverOrderState = deliveryOrderStateAndRef.state.data.copy(
                accepted = true
            )
            
            transactionBuilder
                .addInputState(deliveryOrderStateAndRef)
                .addOutputState(state = newDeliverOrderState, contract = DeliveryOrderContract::class.qualifiedName!!)
                .addCommand(
