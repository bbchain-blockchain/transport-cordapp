...
package com.template.flows.internal
...
@InitiatingFlow
@StartableByRPC
class ReserveProductsFlowInitiator(
    ...
    override fun call() {
        ...
        transactionBuilder
            ...
            .addCommand(data = StockContract.Commands.AddProduct(), keys = listOf(ourIdentity.owningKey))
