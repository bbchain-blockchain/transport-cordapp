...
class FlowTests {
    ...
    private val retail = mockNetwork.createNode(CordaX500Name("Retail","London","GB"))
    private val distributor = mockNetwork.createNode(CordaX500Name("Distributor","London","GB"))
    private val producer = mockNetwork.createNode(CordaX500Name("Producer","London","GB"))
    private val transporter = mockNetwork.createNode(CordaX500Name("Transporter","London","GB"))
    ...
    private fun createDeliveryOrder(
        ...
        val actualProducerPurchaseOrderState = getStates<PurchaseOrderState>(seller)
        
        assertTrue(actualDistributorPurchaseOrderState.isEmpty())
        assertTrue(actualProducerPurchaseOrderState.isEmpty())
